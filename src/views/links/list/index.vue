<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="連結標題" min-width="300px">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" @close="resetTemp()">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="80px" style="width: auto">
        <div>
          ...
          <el-form-item label="連結標題" prop="title">
            <el-input v-model="temp.title" />
          </el-form-item>
          <el-form-item label="電話號碼" prop="phone">
            <el-input v-model="temp.phone" />
          </el-form-item>
          <el-form-item label="FB連結" prop="fb">
            <el-input v-model="temp.fb" />
          </el-form-item>
          <el-form-item label="網站連結" prop="web">
            <el-input v-model="temp.web" />
          </el-form-item>
        </div>
...
import { fetchList, createLink, updateLink, deleteLink, fetchCate } from '@/api/links'
