      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="80px" style="width: auto">
        <div>
          <el-form-item label="標題" prop="title">
            <el-input v-model="temp.title" placeholder="新增類別" style="width: 200px;" />
          </el-form-item>
          ...
          <el-form-item label="文字說明" prop="description">
...
import { fetchList, createNotice, updateNotice, deleteNotice } from '@/api/notice'
